...
export default function Resume() {
  ...
  function clickHandler () {
    document.getElementById("message").innerHTML  = "Thank you for downloading!";
    window.open(Career);
  }
          ...
          <section>
            <div className="container" data-aos="fade-up">
                <h2 style={styles.heading}>
                  {/* change this to click event to appear or remove it  <button className="resume-button" onClick={() => window.open(Career)}>Resume</button> for details about Dr Chen <em>Thank you for downloading!</em></h2>*/}
                  Please Do Not Hesitate to Press <button className="resume-button" onClick={clickHandler}>Resume</button> for details about Dr Chen <em id="message"></em>
                </h2>
            ...
            <div className="row">
                ...
                <div className="col-lg-6">
                  <h3 className="resume-title">Career Development</h3>
                    <div className="resume-item">
                      <h4><strong>Selected Experience </strong><button className="resume-button" onClick={clickHandler}>Resume</button></h4>
                        <ul>
                ...
                <div className="col-lg-6">
                  <h3 className="resume-title">Proficiencies</h3>
                    <div className="resume-item">
                        <h4>Overall <button className="resume-button" onClick={clickHandler}>Resume</button></h4>
                          <ul>
                ...
                <div className="col-lg-6">
                  <h3 className="resume-title">Coding Skills</h3>
                    <div className="resume-item">
                      <h4>Full Stack Development <button className="resume-button" onClick={clickHandler}>Resume</button></h4>
                        <ul>
                          <li>MySQL</li>
